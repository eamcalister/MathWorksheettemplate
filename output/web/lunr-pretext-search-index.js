...
},
{
  ...
  "number": "2",
  "title": "",
  "body": "  The graph below shows the graph of and a another parabola that is the result of some sequence of transformations of .    Describe the transformations applied to , in order, to obtain . (There are three of them and the order they're performed matters.)      Find the formula for based on your answer to (a). What form of a quadratic function is this?      Suppose you take and reflect its graph across the -axis, then reflect it across the -axis resulting in a new function .  i  Sketch the graph of on the given axes.   ii  How can you obtain the graph of as transformations of (without going to first)?        "
},
{
